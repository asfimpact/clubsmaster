...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-security-mgmt': RouteRecordInfo<'admin-security-mgmt', '/admin/security-mgmt', Record<never, never>, Record<never, never>>,
    ...
    'business-membership-history': RouteRecordInfo<'business-membership-history', '/business-membership-history', Record<never, never>, Record<never, never>>,
    'business-payment-history': RouteRecordInfo<'business-payment-history', '/business-payment-history', Record<never, never>, Record<never, never>>,
